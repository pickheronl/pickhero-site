        ...
        <div className="relative bg-ink rounded-3xl p-12 lg:p-20 text-center overflow-hidden">
          ...
          <div className="relative">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary-foreground mb-6">
              Klaar om je magazijn te optimaliseren?
            </h2>
            <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Start vandaag nog met PickHero en ontdek hoe eenvoudig efficiënt magazijnbeheer kan zijn. 14 dagen gratis, geen creditcard nodig.
            </p>
