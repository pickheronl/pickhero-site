const StatsSection = () => {
  const stats = [
    { value: "Schaalbaar", label: "Pick & pack voor groeiende webshops" },
    { value: "99.9%", label: "Uptime SLA gegarandeerd" },
    { value: "< 5 min", label: "Live & operationeel" },
    { value: "Samen", label: "Gebouwd door e-commerce ondernemers" },
  ];
