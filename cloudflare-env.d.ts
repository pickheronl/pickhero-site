/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9394be0b0db301a00fc9d302aa48118e)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL_FROM: "hello@pickhero.nl";
		NOTIFICATION_EMAIL: "hello@pickhero.nl";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "NOTIFICATION_EMAIL" | "PAYLOAD_SECRET" | "R2_PUBLIC_URL" | "POSTMARK_API_KEY">> {}
}
